...
function intermediateFunction(n, arr) {
  ...
  for (let i = n - 1; i < length; i++) {
    ...
    if (currentProduct > currentGreatestProduct) {
...
function largestProductinaSeries(n) {
  // To pass the FCC tests, I need to either put the unwieldly array into
  // largestProductinaSeries, or else use an intermediate function to get
  // around this problem
  return intermediateFunction(n, thousandDigits);
}
